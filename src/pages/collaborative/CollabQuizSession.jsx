              ...
              {isHost && (
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl border-3 border-yellow-300 p-6 shadow-xl">
                  ...
                  <div className="space-y-3">
                    {/* ⚡ SHOW RESULTS BUTTON - RE-ENABLED */}
                    <button
                      onClick={handleShowResults}
                      className="w-full px-4 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-black rounded-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-2"
                    >
